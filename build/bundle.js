...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var routerModule = __webpack_require__(159);
	...
	var Home = __webpack_require__(191);
	var Navbar = __webpack_require__(190);
	var Products = __webpack_require__(192);
	var Cart = __webpack_require__(194);
	var Itemsdescription = __webpack_require__(199);

	module.exports = React.createElement(Router, { history: history }, React.createElement(Route, { component: App }, React.createElement(Redirect, { from: '/', to: '/home' }), React.createElement(Route, { path: 'home', component: Home }), React.createElement(Route, { path: 'products', component: Products }), React.createElement(Route, { path: 'products/:productName', component: Itemsdescription }), React.createElement(Route, { path: 'cart', component: Cart })));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('div', { className: 'app' }, React.createElement('div', null, React.createElement(Navbar, null)), this.props.children);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navbar = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('nav', null, React.createElement('ul', null, React.createElement(Link, { to: '/home' }, React.createElement('li', null, 'Home')), React.createElement(Link, { to: '/products' }, React.createElement('li', null, 'Products')), React.createElement(Link, { to: '/cart' }, React.createElement('li', null, 'cart'))));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement("div", { className: "container" }, React.createElement("p", null, "Welcome to TAG shopping "), React.createElement("div", { className: "row" }, "This is an sample react shopping cart."), React.createElement("div", null, this.props.children));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Items = __webpack_require__(193);
	var DATA = [{
	  "id": 1,
	  "name": "Apple",
	  "price": 8
	...
	var Products = React.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    ...
	    if (typeof Storage !== "undefined") {
	      if (localStorage.getItem("react_cart") == "undefined" || localStorage.getItem("react_cart") == null) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { className: 'container' }, React.createElement('div', null, this.state.fruits.map(function (fruit, i) {
	      return React.createElement(Items, { key: i, name: fruit.name, price: fruit.price });
	    })));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Items = React.createClass({
	    ...
	    storeItemInCart: function storeItemInCart() {
	        var item = {
	    ...
	    render: function render() {
	        return React.createElement('div', { className: 'panel' }, React.createElement('div', null, this.props.name, React.createElement('p', { className: ' strong' }, this.props.price), React.createElement('p', { className: ' strong' }, React.createElement('button', {
	            onClick: this.storeItemInCart,
	            className: 'btn btn-xs btn-danger' }, 'Add to cart'), ' ', React.createElement('br', null), React.createElement(Link, { to: '/products/' + this.props.name,
	            params: { productName: this.props.name } }, React.createElement('li', null, this.props.name, ' Description')))));
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cart = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement("div", { className: "container" }, React.createElement("div", null, React.createElement("table", { className: "table" }, React.createElement("tr", null, React.createElement("td", null, "Item Name"), React.createElement("td", null, "price")), this.state.cart.cartItems.map(function (item, i) {
	            return React.createElement("tr", { key: i }, React.createElement("td", null, item.name), React.createElement("td", null, item.price));
	        })), React.createElement("div", null, "Total : ", React.createElement(Total, null))));
	    }
	});
	...
	var Total = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement("span", null, _total);
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Itemsdescription = React.createClass({
	  displayName: "Itemsdescription",

	  render: function render() {
	    return React.createElement("div", { className: "container" }, "YOU HAVE CLICKED ", React.createElement("b", null, this.props.params.productName), ", IM GETTING THIS FROM URL !");
	  }
	});
